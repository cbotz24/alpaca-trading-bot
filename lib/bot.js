...
const MAX_POSITION_PCT = 0.20; // max 20% of portfolio per position (~$40 on a $200 account)
const MAX_POSITIONS = 4;       // max concurrent positions (4 × $40 = $160, keeps $40 cash buffer)
